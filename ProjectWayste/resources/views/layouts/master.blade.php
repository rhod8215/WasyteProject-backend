    ...
    -->
      <div class="logo">
        <a href="/dashboard" class="simple-text logo-mini">
            <h2>
                <img src="../assets/img/wayste-truck-logo.png" class="" style="height: 100%; width:100%;">
                <!-- <i class="now-ui-icons shopping_delivery-fast"></i> -->
            </h2>
        </a>
        <a href="/dashboard" class="simple-text logo-normal" style="padding-top: 20px;">
          Wayste App
        </a>
      </div>
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  ...
                  {{ app('App\Http\Controllers\DashboardController')->getNameOfUser()->firstname }}
                  {{ app('App\Http\Controllers\DashboardController')->getNameOfUser()->lastname }}
                  <i class="now-ui-icons users_single-02"></i>
                  <!-- <p>
...
<script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/buttons/1.5.6/css/buttons.dataTables.min.css"></script>
<script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/buttons/1.5.6/js/dataTables.buttons.min.js"></script>
<script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/colreorder/1.5.1/css/colReorder.dataTables.min.css"></script>
